...
import { useDisabledScrollBounce } from "@/hooks/use-disable-scroll-debounce";
...
export default function Canvas({ boardId }: ICanvasProps) {
  ...
  const pencilDraft = useSelf((e) => e.presence.pencilDraft);
  ...
  const updateSelectionNet = useMutation(
    ({ storage, setMyPresence }, current: Point, origin: Point) => {
      ...
      let ids = findIntersectingLayerWithRectangle(
        layerIds,
        layers,
        origin,
        current
        ...
        >
          {layerIds.map((e) => (
            <LayerPreview
              ...
              selectionColor={layerIdsToColorSelection[e]}
            />
          ))}
